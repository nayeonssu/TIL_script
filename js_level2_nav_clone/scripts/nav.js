...
const mNavOpen = document.querySelector('.m_nav_open');//js 붙여넣기 위치를 변수로 변경한것
const gnb = document.querySelector('.gnb');
const gnbClone = gnb.cloneNode(true);
console.log(mNavOpen,gnb,gnbClone);//확인
mNavOpen.appendChild(gnbClone);//마지막 자식 위치로 붙여넣기

//데스크탑 nav-lnb 숨기기
//모바일 m_nav_lnb 숨기기
const navLnb = document.querySelectorAll('nav .lnb');//모바일 메뉴
